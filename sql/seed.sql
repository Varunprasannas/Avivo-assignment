...
VALUES
  ...
  (12, 'Lucas',    'White',    '',         41, 'male',   'lucas.white@x.dummyjson.com',      '+49 30 12345678',  'lucasw',    '1984-02-28', 'https://dummyjson.com/icon/lucasw/128',    'AB+', 188.00, 85.30, 'Green',  'Grey',   'Straight', '192.0.2.100',    'aa:bb:cc:dd:ee:07', 'Humboldt-Universitat zu Berlin',        '789-012', '789-012-345', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 Chrome/101.0',     'user'),
...
INSERT INTO user_addresses (user_id, street, city, state, state_code, postal_code, lat, lng, country) VALUES
  ...
  (11, '15 Rue de Rivoli',      'Paris',         'Ile-de-France','IDF','75001',  48.860611,   2.337644, 'France'),
...
INSERT INTO user_bank (user_id, card_expire, card_number, card_type, currency, iban) VALUES
  ...
  (13, '02/28', '3714496353984310', 'American Express',          'JPY', 'JP0123456789012345678901'),
...
INSERT INTO user_company (user_id, department, name, title, street, city, state, state_code, postal_code, lat, lng, country) VALUES
  ...
  (11, 'Design',                 'Creative Studios SARL',     'UX Designer',               '22 Rue du Faubourg',     'Paris',         'Ile-de-France','IDF','75008',  48.873792,   2.308388,'France'),
